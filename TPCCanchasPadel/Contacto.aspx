<%@ Page Language="C#" AutoEventWireup="true"
    MasterPageFile="~/Canchas.master"
    CodeBehind="Contacto.aspx.cs"
    Inherits="TPCCanchasPadel.Contacto" %>

<asp:Content ID="headContacto" ContentPlaceHolderID="head" runat="server">

  <style>
    .contact-hero{
      background-color:#0b1f17; min-height:40vh;
    ...
    .contact-card{
      ...
      border-radius:.5rem; box-shadow:0 6px 24px rgba(0,0,0,.08); padding:1.5rem;
    }
  </style>
</asp:Content>
  ...
  <div class="container py-5 contact-wrap">
    <div class="contact-card">
      ...
      <p class="mb-4">
        ...
        También podés escribir a <a href="mailto:consultas@dondejuego.com">consultas@dondejuego.com</a>.
      </p>
      ...
      <div class="mb-3">
        ...
        <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control"
          ...
          MaxLength="80" minlength="2" required="required" inputmode="text"
      ...
      <div class="mb-3">
        ...
        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"
          TextMode="Email" placeholder="tuemail@ejemplo.com"
          required="required" autocomplete="email" MaxLength="120" />
      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-3">
          ...
          <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control"
            ...
            required="required" inputmode="tel" MaxLength="15" pattern="^\d{6,15}$" />
      ...
      <div class="mb-3">
        ...
        <asp:TextBox ID="txtMensaje" runat="server" CssClass="form-control"
          TextMode="MultiLine" Rows="4" MaxLength="800" minlength="5"
          required="required" placeholder="Contanos brevemente tu consulta" />
