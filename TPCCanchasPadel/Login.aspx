<%@ Page Title="Inicia Sesion" Language="C#" AutoEventWireup="true" MasterPageFile="~/Canchas.master" CodeBehind="Login.aspx.cs" Inherits="TPCCanchasPadel.Login" %>

<asp:Content ID="headLogin" ContentPlaceHolderID="head" runat="server">
    <link href="Content/bootstrap.css" rel="stylesheet" />
    <style>
        .login-hero{ background-color:#0b1f17; min-height:40vh; display:flex; align-items:center; text-align:center; color:#fff; }
        .login-hero h1{ font-weight:800; letter-spacing:.5px; margin-bottom:.5rem; }
        .login-hero h1 span{ color:#ffd000; }
        .login-wrap{ max-width:520px; }
        .login-card{ background:#fff; border:1px solid rgba(0,0,0,.08); border-radius:.5rem; box-shadow:0 6px 24px rgba(0,0,0,.08); padding:1.5rem; }
    </style>
</asp:Content>

<asp:Content ID="contenidoLogin" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container login-wrap">
            <div class="login-card">
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control" MaxLength="20" minlength="4" required="required" autocomplete="username" inputmode="text" spellcheck="false" pattern="^(?![._-])(?:[A-Za-z0-9]|[._-](?![._-])){3,18}[A-Za-z0-9]$" />
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" TextMode="Password" required="required" autocomplete="current-password" spellcheck="false" />
                    <div class="invalid-feedback">Por favor, ingresá datos correctos.</div>
                </div>
