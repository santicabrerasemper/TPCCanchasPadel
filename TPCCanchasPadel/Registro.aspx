    ...
    <body>
        ...
        <form id="form1" runat="server" class="needs-validation" novalidate>
            <section class="registro-hero">
                <div class="container py-4">
                    <h1 class="mb-2">Creá tu <span>cuenta</span></h1>
                    <p class="lead mb-0">Registrate para reservar tu cancha en minutos.</p>
                </div>
            </section>
                ...
                <div class="container registro-wrap">
                    <div class="registro-card">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control" MaxLength="20" minlength="4" required="required" autocomplete="username" inputmode="text" spellcheck="false" pattern="^(?![._-])(?:[A-Za-z0-9]|[._-](?![._-])){3,18}[A-Za-z0-9]$" placeholder="ej: juan.perez" />
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" MaxLength="50" minlength="2" required="required" inputmode="text" autocomplete="given-name" pattern="^(?! )(?!.* {2,})(?!.* $)[A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+(?:[ '\-][A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+)*$" placeholder="Nombre" />
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtApellido" runat="server" CssClass="form-control" MaxLength="50" minlength="2" required="required" inputmode="text" autocomplete="family-name" pattern="^(?! )(?!.* {2,})(?!.* $)[A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+(?:[ '\-][A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+)*$" placeholder="Apellido" />
                            <div class="invalid-feedback">
                                Solo letras (con tildes). Se permiten espacios simples, guion y apóstrofe.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" TextMode="Password" required="required" autocomplete="new-password" spellcheck="false" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*_+\-])[A-Za-z\d!@#$%^&*_+\-]{6,50}$" placeholder="ej: Prog3#" />
                            <div class="form-text">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtConfirm" runat="server" CssClass="form-control" TextMode="Password" required="required" placeholder="Repetí la contraseña" />
        ...
        <script>
            (() => {
                ...
                if (usuario) {
                    usuario.addEventListener('input', () => { usuario.value = usuario.value.replace(/\s+/g, ''); });
